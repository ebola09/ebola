(() => {
    ...
    if (window.PokiSDK = {
            ...
            isAdBlocked: () => {},
            getUser: a.withPromise("getUser"),
            getToken: a.withPromise("getToken"),
            login: a.withPromise("login")
        ...
        const o = crypto.randomUUID(),
            i = e("game_id"),
            a = e("game_version_id"),
            s = "1" === localStorage.getItem("poki_pbf");
        window.PokiSDK.measure = (e, r, d) => {
            if (e = `${e}`, r = void 0 === r ? "" : `${r}`, d = void 0 === d ? "" : `${d}`, window.pokiMeasureBuildin = !0, window.parent.postMessage({
    ...
    const s = (() => {
            const n = window.pokiSDKVersion || e("ab") || "e0a5a05d5366b59f6c17064c325d0eb81a6556d4";
    ...
    r.setAttribute("src", s), r.setAttribute("type", "text/javascript"), r.setAttribute("crossOrigin", "anonymous"), r.onload = () => a.dequeue(), document.head.appendChild(r)
})();